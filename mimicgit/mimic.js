github_source_code = [
  {
    source_uri:
      "https://gist.githubusercontent.com/pwnedDesal/e7f77c8c4f9cbcda5d3a025c3bf6770c/raw/3af787081809effe8b59be1ef28e8e46e061582d/server.js",
    cont_ID: "a",
  },
  {
    source_uri:
      "https://gist.githubusercontent.com/pwnedDesal/4e134b905cefe8398de617258ee8010d/raw/4ca1faa5287d780894bd82ad6c1a6684a1043486/index.php",
    cont_ID: "b",
  },
  {
    source_uri:
      "https://gist.githubusercontent.com/deadstar1/3cb788d3ad7354bfb9de/raw/0598570486a6aa721f46449cb871f1644dc59cf2/test1.html",
    cont_ID: "c",
  },
];
...
function mimic_git(text_response, randomstring, username, filename) {
  ...
  text = text_response;
  var tableofcontent = document.getElementById(
    "tableofcontent-" + randomstring
  );
  ...
  for (var i = 0; i < codex.length; i++) {
    ...
    syntax_highlighter = [
      {
        replacement: "<span style='color:#ff7b7b'>$1</span>",
        regex: "([0-9])+",
      },
      {
        replacement: "<span style='color:#a6e22e'>$1</span>",
        regex: "(&quot;.{1,10}&quot;)",
      },
      {
        replacement: "<span style='color:#66D9EF'>$1</span>",
        regex: "(include|package|this)",
      },
      { replacement: "<span style='color:#66D9EF'>$1</span>", regex: "(echo)" },
      { replacement: "<span style='color:#a6e22e'>$1</span>", regex: "(new)" },
      {
        replacement: "<span style='color:#F3933B'>$1</span>",
        regex: "(isset|long|short|var|if|for|while|do while|&equals;)",
      },
      {
        replacement: "<span style='color:#a6e22e'>$1</span>",
        regex: "(&apos;.{1,10}&apos;)",
      ...
      {
        replacement:
          "<span style='color:#F3933B'>$1<span style='color:#FFD700'>$2<span style='color:white'>$3</span></span></span>",
        regex: "(function)(.+)(((.{0,})){)",
      },
      {
        replacement: "<span style='color:#00FFAC'>$1</span>",
        regex: "(&lt;|&gt;)",
      },
    ...
    while (syntax_highlighter[x]) {
      ...
      raw_htmlcode = raw_htmlcode.replace(
        re,
        syntax_highlighter[x].replacement
      );
      x = x + 1;
    ...
    HTMLcode =
      "<tr id='line-of-code'><td class='line-number' code-line='" +
      i +
      "'></td><td class='code-content'><code>" +
      raw_htmlcode +
      "</code></td></tr>";
    //some check here
    //////
  ...
  metadata =
    filename +
    " <span class='by'>by</span><a class='link-mimic' href=https://github.com/" +
    username +
    ">" +
    username +
    "</a> &#32;&#32;|&#32;&#32;Mimic_Git";
...
<div class='flexy'>
  <div class='body'>
    <span class='footcommand'>
      <span>Toggle:</span>
      <span class='hiddenT'>
        <a class='link-mimic' href="${url}">&lt;/viewraw&gt;</a>| <a href='javascript:document.execCommand(&apos;copy&apos;);' class='link-mimic'>copy me</a>
      </span>
    </span>
    <table class='tableofcontent' id='tableofcontent-${randomstring}'></table>
  </div>
  <div class='output'>
	<div class='output-header'>☰&nbsp;Output &nbsp;&nbsp;&nbsp;&nbsp;<span><button>RUN</button></span></div>
	<div class="output-body">sample output</div>
  </div>
  <div class='footer'>
    <span class='club'>&clubs;&#32;&#32; &#32; </span>
    <span class='user-info' id='user-info-${randomstring}'></span>
  </div>
</div>`;
